...
(function () {
  ...
  function сдвинуть() {
    /* рельс всегда центрирует активную панель: смещаем на ширину панели плюс
       зазор, а вычитаем половину — так центр совпадает с центром экрана */
    var p = панели[активная];
    var шаг = p.offsetWidth + parseFloat(getComputedStyle(рельс).gap || 22);
    рельс.style.transform = 'translateX(' + (-активная * шаг) + 'px)';
  }
