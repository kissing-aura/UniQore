...
(function () {
  ...
  /* Партитура первой загрузки играет один раз. Дальше тот же порядок
     появления, но без стартовой паузы — иначе смена раздела заставляла бы
     ждать секунду на пустом экране. */
