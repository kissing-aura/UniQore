...
(function () {
  ...
  box.innerHTML = ''
    + '<p class="uq-cookie__text">Мы собираем статистику посещений и обезличенно смотрим, как люди '
    + 'пользуются сайтом, — так он становится удобнее. Если вы оставляете заявку и ставите согласие '
    + 'в форме, введённый контакт для этой заявки не обезличен — так мы не теряем её при сбоях. '
    + 'Нажмёте «Только необходимые» — оставим лишь базовый счётчик, без записи действий и Google '
    + 'Analytics. Подробнее — в <a href="' + POLICY + '">политике конфиденциальности</a>.</p>'
