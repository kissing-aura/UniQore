...
(function () {
  ...
  var NICHES = {
    restaurant: {
      ...
      rows: [
        ['Гость · Стол на 6', '$120', 'Бронь', 'wip', 'y', false],
        ['Банкет · 20 человек', '$1 400', 'КП', 'wip', 'g', true],
        ['Доставка · Центр', '$54', 'Оплата ✓', 'done', 'g', false],
      ],
      toasts: ['Новая бронь · стол 4', 'Заказ доставки · +$54', 'Банкет на вечер · 20 гостей', 'Новый отзыв · 5★'],
