...
(() => {
  ...
  const MENU = [
    { id: 'dish1',  name: 'Бургер «Классик»',          category: 'Бургеры',     cost: 190,  price: 490,  weight: 320, isPopular: true,  veg: false, qty: 118 },
    { id: 'dish2',  name: 'Бургер «Двойной чизбургер»', category: 'Бургеры',    cost: 230,  price: 620,  weight: 400, isPopular: true,  veg: false, qty: 74 },
    { id: 'dish3',  name: 'Бургер «Грибной вег»',      category: 'Бургеры',     cost: 180,  price: 470,  weight: 310, isPopular: false, veg: true,  qty: 48 },
    { id: 'dish4',  name: 'Пицца «Маргарита» 35 см',   category: 'Пицца',       cost: 280,  price: 720,  weight: 580, isPopular: true,  veg: true,  qty: 112 },
    { id: 'dish5',  name: 'Пицца «Пепперони» 35 см',   category: 'Пицца',       cost: 320,  price: 890,  weight: 620, isPopular: true,  veg: false, qty: 108 },
    { id: 'dish6',  name: 'Пицца «Четыре сыра»',       category: 'Пицца',       cost: 350,  price: 950,  weight: 600, isPopular: false, veg: true,  qty: 26 },
    { id: 'dish7',  name: 'Шаурма куриная «Большая»',  category: 'Шаурма',      cost: 140,  price: 380,  weight: 400, isPopular: true,  veg: false, qty: 102 },
    { id: 'dish8',  name: 'Шаурма с говядиной',        category: 'Шаурма',      cost: 170,  price: 430,  weight: 420, isPopular: false, veg: false, qty: 10 },
    { id: 'dish9',  name: 'Роллы «Калифорния» (8 шт)', category: 'Роллы',       cost: 210,  price: 560,  weight: 280, isPopular: true,  veg: false, qty: 96 },
    { id: 'dish10', name: 'Роллы «Дракон»',            category: 'Роллы',       cost: 250,  price: 680,  weight: 300, isPopular: false, veg: false, qty: 22 },
    { id: 'dish11', name: 'Роллы «Авокадо» (вег)',     category: 'Роллы',       cost: 190,  price: 520,  weight: 260, isPopular: false, veg: true,  qty: 44 },
    { id: 'dish12', name: 'Картофель фри «Большой»',   category: 'Закуски',     cost: 60,   price: 190,  weight: 300, isPopular: true,  veg: true,  qty: 152 },
    { id: 'dish13', name: 'Куриные крылья BBQ (6 шт)', category: 'Закуски',     cost: 130,  price: 370,  weight: 380, isPopular: true,  veg: false, qty: 68 },
    { id: 'dish14', name: 'Луковые кольца',            category: 'Закуски',     cost: 55,   price: 170,  weight: 220, isPopular: false, veg: true,  qty: 40 },
    { id: 'dish15', name: 'Суп «Борщ» с пампушками',  category: 'Супы',        cost: 120,  price: 320,  weight: 400, isPopular: true,  veg: false, qty: 36 },
    { id: 'dish16', name: 'Крем-суп из тыквы',        category: 'Супы',        cost: 90,   price: 260,  weight: 350, isPopular: false, veg: true,  qty: 32 },
    { id: 'dish17', name: 'Кола 0.5 л',               category: 'Напитки',     cost: 30,   price: 120,  weight: 500, isPopular: true,  veg: true,  qty: 178 },
    { id: 'dish18', name: 'Лимонад «Клубника-мята»',  category: 'Напитки',     cost: 45,   price: 150,  weight: 400, isPopular: false, veg: true,  qty: 62 },
    { id: 'dish19', name: 'Тирамису',                  category: 'Десерты',     cost: 110,  price: 290,  weight: 150, isPopular: true,  veg: true,  qty: 90 },
    { id: 'dish20', name: 'Чизкейк «Нью-Йорк»',       category: 'Десерты',     cost: 130,  price: 320,  weight: 160, isPopular: false, veg: true,  qty: 18 },
  ];
  ...
  window.RECIPE = {
    ...
    nav: [
      ...
      { key: 'menumatrix', label: 'ИИ-инженерия меню', type: 'menumatrix',                       group: 'Каталог', icon: 'spark', badge: 'AI' },
