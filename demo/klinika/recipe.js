...
(() => {
  ...
  const APPOINTMENTS_RAW = [
    ...
    ['ИИ-диагностика снимка — Николай Орлов',        'p6',  'Рогов И.С.',        ds(-19), 1500,  'paid', 'Диагностика', 20],
  ...
  const invoices = [
    ...
    { id: 'inv7', name: 'Счёт №007 — Диагностика Орлов', patient: 'Николай Орлов', amount: 1500, status: 'paid', date: ds(-19), service: 'ИИ-диагностика снимка', stage: 'paid' },
